export const Task = (task) => {
  ...
  taskItem.className = `task ${priorityClass} py-2 px-4 rounded shadow-md flex flex-col gap-2 border-l-4 hover:bg-theme-surface-2 duration-200 justify-between`
